#if !defined(LIB_CPU_H_TAME)
#define LIB_CPU_H_TAME
...
/* Get CPU's family number */
int get_family(void);

/* Get CPU's vendor string */
char *get_vendor_str(void);

/* Get CPU's brand
 * @param brand: string to store brand */
void get_cpu_brand(char *brand);

/* Check for CPUID feature (ECX)
 * @param cpuidfeat: the CPUID feature */
int check_ecx_feat(unsigned int cpuidfeat);

/* Check for CPUID feature (EDX)
 * @param cpuidfeat: the CPUID feature */
int check_edx_feat(unsigned int cpuidfeat);

#endif /* LIB_CPU_H_TAME */